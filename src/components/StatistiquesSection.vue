...
const stats = [
  {
    value: '12 years',
    label: 'Have been teaching students from 50+ countries across the world.',
  },
  {
    value: '20 000+',
    label: 'Students have graduated so far.',
  },
  {
    value: '75.8%',
    label:
  ...
  {
    value: '24/7',
    label: 'Support group is ready to help you if you have questions.',
  },
]
